...
function maybeProactiveContact(){
  ...
  const interval=Number(state.settings.proactiveIntervalHours??8);
  if(interval<=0||!last||now-last<interval*3600000||now-lastProactive<Math.max(interval,8)*3600000)return;
