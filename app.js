...
function saveNest(){normalizeNestData();nestData.toG=$("#nestToG").value.trim();nestData.note=$("#nestNote").value.trim();nestData.updatedAt=Date.now();saveNestData();renderNestHome()}
